    ...
    <div className="min-h-screen flex items-center justify-center
      ...
      <div className="w-full max-w-sm">
              ...
              {!forgotSent ? (
                <form onSubmit={handleForgotPassword} className="space-y-4">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200
                                  dark:border-amber-700 rounded-lg px-3 py-3">
                    <p className="text-xs text-amber-800 dark:text-amber-300 leading-relaxed">
                      ⚠️ <strong>Important:</strong> Due to end-to-end encryption, resetting 
                      your password will <strong>permanently delete all your financial data</strong>. 
                      You will start with a fresh account. This cannot be undone.
                    </p>
                  </div>
                  <input
                    type="email" required
        ...
        <div className="text-center text-xs text-gray-400 dark:text-gray-500 mt-6">
          <p>Your data is encrypted end-to-end. We never see your transactions.</p>
          <a href="/privacy.html" className="hover:text-gray-600 dark:hover:text-gray-300 underline mt-1 inline-block">Privacy Policy</a>
        </div>
      </div>
    </div>
  )
